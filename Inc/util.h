...
#define INF_PRINTLN(...) printf("INF: ");printf(__VA_ARGS__);printf("\n")
#define DBG_PRINTLN(...) printf("DBG: ");printf(__VA_ARGS__);printf("\n")
#define WRN_PRINTLN(...) printf("WRN: ");printf(__VA_ARGS__);printf("\n")
#define ERR_PRINTLN(...) printf("ERR: ");printf(__VA_ARGS__);printf("\n")
